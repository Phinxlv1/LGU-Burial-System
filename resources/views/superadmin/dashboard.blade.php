...
<aside class="sidebar">
    <div class="sidebar-brand">
        <div class="sidebar-brand-top">
            {{-- Fixed: removed duplicate broken alt attribute from original --}}
            <img src="{{ asset('images/carmen-seal.png') }}" alt="Municipality of Carmen Seal" class="sidebar-seal">
...
<div class="main">
    ...
    <div class="content">
            ...
            <div class="card">
                <div class="card-head">
                    <div>
                        ...
                        <div class="card-head-sub">{{ now()->year }} — permits per month</div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="chart-row">
            ...
            <div class="card">
                <div class="card-head"><div class="card-head-title">Permit Type Breakdown</div></div>
                <div class="card-body"><canvas id="feeChart" height="220"></canvas></div>
            </div>
        </div>
    </div>
</div>
