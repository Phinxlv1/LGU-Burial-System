...
class BurialPermitController extends Controller
{
        ...
        if ($sort === 'last_name') {
            ...
            $query->orderByRaw("
                CASE 
                    ...
                    WHEN status = 'released' AND expiry_date IS NOT NULL AND expiry_date <= DATE_ADD(NOW(), INTERVAL 30 DAY) THEN 2
    ...
    public function release(BurialPermit $permit)
    {
        ...
        ActivityLog::record(
            ...
            modelLabel: $permit->permit_number,
            oldValues: $old,
            newValues: ['status' => 'released', 'expiry_date' => now()->addYear()->toDateString()],
    ...
    public function destroy(BurialPermit $permit)
    {
        ...
        ActivityLog::record(
            ...
            description: "Permit {$label} deleted"
        );
    ...
    public function renew(BurialPermit $permit)
    {
        ...
        ActivityLog::record(
            ...
            modelLabel: $permit->permit_number,
            oldValues: $old,
            newValues: ['status' => 'released', 'expiry_date' => $permit->fresh()->expiry_date->toDateString(), 'remarks' => $permit->fresh()->remarks],
            description: "Permit {$permit->permit_number} renewed"
        );
